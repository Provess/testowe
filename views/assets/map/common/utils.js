class Utils {
    ...
    static getCustomIcon(icon_id = undefined, icon_mode = undefined) {
        var background_path = icon_mode ? `/assets/map/images/icons/marker_${icon_mode}.svg` : "/assets/map/common/icons/marker.svg";
        ...
        if (icon_id.startsWith('fa-') && icon_id.endsWith('x')) {
            return L.divIcon({
                className: 'map-marker',
                html: `
            <img class="map-marker-background" src="${background_path}" />
            <div class="map-marker-foreground-wrapper" style="color: red"><i class="fas ${icon_id} map-marker-foreground"></i></div>
            `,
                iconSize: [25, 41],
                popupAnchor: [1, -34],
                iconAnchor: [12, 41],
        ...
        if (icon_id.startsWith('fa-')) {
            ...
            return L.divIcon({
                ...
                html: `
                <img class="map-marker-background" src="${background_path}" />
                <div class="map-marker-foreground-wrapper"><img class='map-marker-foreground' src='/assets/map/images/icons/${icon_id}.png' /></div>
                `,
                iconSize: [25, 41],
                popupAnchor: [1, -34],
                iconAnchor: [12, 41],
